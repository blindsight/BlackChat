...
MKDIRS="sh /home/yr/project/bc/ncurses/mkdirs.sh"
...
*.[0-9]*)
	...
	if test ! -f /home/yr/project/bc/ncurses/man_alias.sed ; then
cat >>/home/yr/project/bc/ncurses/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TPUT@,tput,
CF_EOF2
		echo "...made /home/yr/project/bc/ncurses/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /home/yr/project/bc/ncurses/man_alias.sed | sort -u`
	cf_target=`grep "^$cf_source" /home/yr/project/bc/ncurses/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f /home/yr/project/bc/ncurses/man_alias.sed \
		< $i | sed -f /home/yr/project/bc/ncurses/edit_man.sed >$TMP
